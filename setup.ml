...
(* OASIS_START *)
(* DO NOT EDIT (digest: e26690f951a4eb3f2ff610dd929b8180) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Band"; "Data_set"; "Driver"; "Lib"];
                      lib_pack = true;
                      lib_internal_modules = ["T"];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
     ...
     oasis_version = "0.4.2";
     oasis_digest = Some "m+\224\233\b\191\016\154\139H\020s\132\161\240\240";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
