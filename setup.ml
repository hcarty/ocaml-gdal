...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0daf7901f3f7226ed30d92034f04ac26) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/ocaml-gdal";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "examples";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "gdal"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "sanity.ml"});
               Executable
                 ({
                     cs_name = "warptut";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "warptut.ml"});
               Executable
                 ({
                     cs_name = "warptut1";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "warptut1.ml"});
               Executable
                 ({
                     cs_name = "band_iter";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "band_iter.ml"});
               Executable
                 ({
                     cs_name = "alg_test";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "alg_test.ml"});
               Executable
                 ({
                     cs_name = "contour";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "contour.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/ocaml-gdal.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/ocaml-gdal";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\154\240A\029\236C!4\026\154v\234\155\234\208\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
